...
export function Notification({ 
  ...
  return (
    <div className="fixed top-20 right-4 z-50 max-w-sm">
      <div className={`rounded-lg p-4 shadow-lg border animate-fade-in ${styles.bg} ${styles.text}`}>
        <div className="flex items-start">
          ...
          <button
            onClick={onClose}
            className="ml-4 inline-flex text-gray-400 hover:text-gray-200 transition-colors"
          >
